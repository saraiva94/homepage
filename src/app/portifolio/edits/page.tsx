...
const FRAME_START = 1;     // começa em 001
const FRAME_END   = 300;   // termina em 300
...
const frameURL = (idx0: number) => {
  const n = FRAME_START + idx0; // 0->1, 299->300
  return encodeURI(`${FRAMES_DIR}/${FRAME_BASENAME} ${String(n).padStart(3, "0")}.${FRAME_EXT}`);
};
